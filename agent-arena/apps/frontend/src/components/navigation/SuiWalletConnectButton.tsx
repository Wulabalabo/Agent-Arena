...
function SuiWalletConnectButtonContent() {
  ...
  return (
    <div className="relative">
      <button
        className="paper-button paper-button-primary inline-flex items-center gap-2 px-3 py-1.5 font-display text-xs font-black uppercase"
      ...
      {dialogOpen ? (
        <div
          aria-label="Connect owner wallet"
          className="paper-card-sm absolute right-0 top-10 z-50 grid min-w-56 gap-2 p-3"
          role="dialog"
        >
